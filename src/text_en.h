...
public:
	...
	std::string help () const override { return std::string() +
		...
		"\n"
		"    without specifying the <outfile>, the input filename + extension '.scad'\n"
		"    is written to the same directory.\n"
		"\n"
		"    -?, --help               show help\n"
		"    -f, --force              force overwriting of output files\n"
		"    -p, --points-faces       output data: write points and triangles, default\n"
		"                             group equal points together.\n"
		"    -P, --points-only        output data: write only points,\n"
		"                             generate triangles from OpenSCAD.\n"
		"                             faster convert speed, but 2-3 times larger file size.\n"
