...
public:
	...
	std::string help () const override { return std::string() +
		...
		"\n"
		"    Ohne Angabe der <Ausgabedatei> wird der Eingabedateiname + Endung '.scad'\n"
		"    in das gleiche Verzeichnis geschrieben.\n"
		"\n"
		"    -?, --help               Hilfetext anzeigen lassen\n"
		"    -f, --force              Ausgabedatei überschreiben, wenn sie existiert\n"
		"    -p, --points-faces       Ausgabedaten: Punkte und Dreiecke schreiben, Standart\n"
		"                             Gleiche Punkte werden zusammengefasst.\n"
		"    -P, --points-only        Ausgabedaten: nur Punkte schreiben,\n"
		"                             Dreiecke von OpenSCAD generieren lassen.\n"
		"                             Schnellere Umwandlung, aber 2-3 mal größere Dateigröße.\n"
